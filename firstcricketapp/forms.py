...
from .models import TournamentDetails, TeamDetails, PlayerDetails, CreateMatch
...
class PlayerForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['player_name', 'team', 'role', 'is_captain', 
                  'is_vice_captain', 'jersey_number', 'mobile_number']  # add mobile_number here
