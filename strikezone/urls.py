...
urlpatterns = [
    ...
    path('tournaments/<int:tournament_id>/edit-teams/',     views.edit_teams_view,      name='edit_teams'),
    path('tournaments/<int:tournament_id>/move-player/',    views.move_player_view,     name='move_player'),
